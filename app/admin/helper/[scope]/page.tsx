...
const SMARTPHONE_FIELD_SUGGESTIONS: Record<string, string[]> = {
  ...
  General: ["Origin / Country", "All Selected Package Contents (Public Order)"],
  ...
  Display: ["Type", "Protection", "Dimming", "Stylus / Pen", "Certification", "Other Features"],
  ...
  Camera: ["Flash Name", "AF Detail", "Camera Features", "Sensor Name", "Lens Type", "Autofocus Detail", "Video Type", "Video Resolution", "Comment", "Video Features", "Camera Type", "Visible Posture"],
